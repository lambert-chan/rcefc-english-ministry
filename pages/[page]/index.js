  ...
  const reorderedAboutPages =
    pageData.slug === "about"
      ? pageData.children.edges.sort((a, b) => {
          ...
          // make resource last
          if (aSlug === RESOURCE_PAGE_SLUG && bSlug !== RESOURCE_PAGE_SLUG) {
            return 1;
          }
          if (aSlug !== RESOURCE_PAGE_SLUG && bSlug === RESOURCE_PAGE_SLUG) {
            return -1;
          ...
          <LayoutV1>
            ...
            {pageData.slug == "join-us" && (
              <SmallBanner className="white">
                ...
                <p>
                  Community helps us grow, it supports us in times of need and
                  we all need some connection in order for us accomplish more as
            ...
            {reorderedAboutPages.map((edge) => {
              ...
              return (
                <PageBanner
                  className={++banner_index % 2 == 0 ? theme : "white"}
                  id={subpage.slug}
                  key={subpage.slug}
                >
